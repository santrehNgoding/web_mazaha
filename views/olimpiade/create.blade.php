...
label{
    ...
    <div id="grid" style="height:100%;display:grid;">
        ...
        <div class="my-auto">
            ...
            <form method="post" action="{{route('olimpiade.store')}}" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="tingkat" id="" class="border-0 rounded-2 py-1 w-100">
                ...
                <div class="form-group mb-3">
                    ...
                    <br>
                    <textarea class="w-100 rounded-3" style="border:none;" name="berita" id="" cols="30" rows="10"></textarea>
                </div>
