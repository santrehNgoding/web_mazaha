...
<body>
    <footer>
        ...
        <div  class="d-flex justify-content-around flex-wrap">
            <div class="py-1">
                <h3 class="fw-bold text-center mb-3 text-light">Google Map</h3>
            ...
            <div class="ml-auto" id="foot">
                ...
                <ol>
                    ...
                    <li>Jam'iyyatul Qura Wal Huffaz</li>
            ...
            <div class="ml-auto p-1" id="foot">
                ...
                <form action="">
                    ...
                    <br>
                    <input style="border: 1px white solid;background-color:#033919;color:white;" class="mb-3" type="text">
                    <br>
                    <label class="mb-2" for="">Email</label>
                    <br>
                    <input class="mb-3" style="border: 1px white solid;background-color:#033919;color:white;" type="email">
                    <br>
                    <label class="mb-2" for="">Kritik dan Saran</label>
                    <br>
                    <textarea name="" id="" cols="24" rows="5" style="border: 1px white solid;background-color:#033919;color:white;"></textarea>
                </form>
            </div>
        </div>
