    ...
    <div id="grid" style="height:100%;display:grid;">
        ...
        <div>
            <div style="height:auto;background-color:rgba(20, 131, 20,0.3);margin:10%;padding:5%;border-radius:10px">
                <form method="POST" action="{{route('prodistik.update', $row->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')                
                    <div class="form-group mb-3">
                        <label for="NamaGuru">Nama Dosen</label>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <br>
                        <textarea class="w-100 rounded-3" style="border:none;" name="mapel" id="" cols="30" rows="10">{{$row->mapel}}</textarea>
                    </div>
