...
label{
    ...
    <div id="grid" style="height:100%;display:grid;">
        ...
        <div class="my-auto">
            ...
            <form method="post" action="{{route('prodistik.store')}}" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    <label for="testimoni">tertimoni</label>
                    <br>
                    <textarea class="w-100 rounded-3" style="border:none;" name="testimoni" id="" cols="30" rows="10"></textarea>
                </div>
