...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        .testimoni { font-family: Arial, sans-serif; display: flex;background: linear-gradient(to right, #ffffff 33.33%, #046C3C 33.33%); }
...
function moveSlide(direction) {
    if (direction === 1 && currentIndex >= totalCards - 1) {
        currentIndex = -1; // Untuk kembali ke awal saat di akhir
    } else if (direction === -1 && currentIndex <= 0) {
        currentIndex = totalCards; // Untuk kembali ke akhir saat di awal
    }
...
// Event listener untuk transisi yang mulus di loop
